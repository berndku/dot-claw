...
public sealed class WorkspaceMemoryProvider : AIContextProvider
{
    ...
    public Dictionary<string, string> ReadAll()
    {
        ...
        try
        {
            // Fresh workspace: BOOTSTRAP.md is still present *with content* (the agent retires it once
            // it knows who it is). During bootstrap we withhold AGENTS.md and MEMORY.md — AGENTS.md's
